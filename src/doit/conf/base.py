...
MIDDLEWARE_CLASSES = (
    ...
    'doit.middlewares.social.SocialAuthExceptionMiddleware',
)
...
LOGIN_URL = reverse_lazy('doit-index')
LOGIN_ERROR_URL = reverse_lazy('doit-index')
LOGIN_REDIRECT_URL = reverse_lazy('doit-index')
...
SOCIAL_AUTH_PIPELINE = (
    'doit.pipeline.unique_login',
    'doit.pipeline.conditional_social_details',
...
SOCIAL_AUTH_USERNAME_FORM_URL = reverse_lazy('doit-index')
