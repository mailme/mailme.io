...
from doit.utils.gravatar import get_gravatar
from doit.managers import UserManager
...
class User(AbstractBaseUser):
    ...
    def send_mail(self, subject, message, from_email=None, **kwargs):
        ...
        from doit.tasks import send_mail_async
        send_mail_async.delay(subject, message, from_email, [self.email],
                              **kwargs)

    def get_absolute_url(self):
        return reverse('doit-profile', kwargs={'email': self.email})
